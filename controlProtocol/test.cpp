...
*/
    if( (cpUSB.SetTECTemperature(1, 2, -21.9)) )            // problem - works and flakey/crashy
...
/*
    ...
    if( (cpUSB.SetChillerTemperature(1, 23.3)) )        // get a packet back that is not what is sent
        printf("success for set chiller temperature\n");// need to use different end of packet char
    else
